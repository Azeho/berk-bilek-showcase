...
const videos: { src: string; title: string; categories: VideoFilter[] }[] = [
  // Metal
  { src: "https://berk-bilek.com/videoshorts/m1.mp4",  title: "Metal işleri", categories: ["metal"] },
  { src: "https://berk-bilek.com/videoshorts/m2.mp4",  title: "Metal işleri", categories: ["metal"] },
  { src: "https://berk-bilek.com/videoshorts/m3.mp4",  title: "Metal işleri", categories: ["metal"] },
  { src: "https://berk-bilek.com/videoshorts/m4.mp4",  title: "Metal işleri", categories: ["metal"] },
  { src: "https://berk-bilek.com/videoshorts/m5.mp4",  title: "Metal işleri", categories: ["metal"] },
  { src: "https://berk-bilek.com/videoshorts/m6.mp4",  title: "Metal işleri", categories: ["metal"] },
  { src: "https://berk-bilek.com/videoshorts/m7.mp4",  title: "Metal işleri", categories: ["metal"] },
  { src: "https://berk-bilek.com/videoshorts/m8.mp4",  title: "Metal işleri", categories: ["metal"] },
  { src: "https://berk-bilek.com/videoshorts/m9.mp4",  title: "Metal işleri", categories: ["metal"] },
  { src: "https://berk-bilek.com/videoshorts/m10.mp4", title: "Metal işleri", categories: ["metal"] },
  { src: "https://berk-bilek.com/videoshorts/m11.mp4", title: "Metal işleri", categories: ["metal"] },
  { src: "https://berk-bilek.com/videoshorts/m12.mp4", title: "Metal işleri", categories: ["metal"] },
  { src: "https://berk-bilek.com/videoshorts/m13.mp4", title: "Metal işleri", categories: ["metal"] },
  { src: "https://berk-bilek.com/videoshorts/m14.mp4", title: "Metal işleri", categories: ["metal"] },
  // Mebel
  { src: "https://berk-bilek.com/videoshorts/f1.mp4",  title: "Mebel işleri", categories: ["mebel"] },
  { src: "https://berk-bilek.com/videoshorts/f2.mp4",  title: "Mebel işleri", categories: ["mebel"] },
  { src: "https://berk-bilek.com/videoshorts/f3.mp4",  title: "Mebel işleri", categories: ["mebel"] },
  { src: "https://berk-bilek.com/videoshorts/f4.mp4",  title: "Mebel işleri", categories: ["mebel"] },
  { src: "https://berk-bilek.com/videoshorts/f5.mp4",  title: "Mebel işleri", categories: ["mebel"] },
  { src: "https://berk-bilek.com/videoshorts/f6.mp4",  title: "Mebel işleri", categories: ["mebel"] },
];
  ...
  return (
    <div>
      ...
      <section className="relative h-[50vh] min-h-[300px] flex items-center">
        <img src={heroImg} alt="Metal işleri" className="absolute inset-0 w-full h-full object-cover" fetchPriority="high" decoding="async" />
